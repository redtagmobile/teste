                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="senha" class="form-control" id="exampleInputUsername1" placeholder="Ex: Vilage Palace...">
                                            </div>
                                            
                                      <input type="hidden" name="master" value="<?php echo $_SESSION['user'][0]['id_login']; ?>">
