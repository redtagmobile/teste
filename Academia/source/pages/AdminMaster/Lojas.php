            ...
            <div class="col-md-12">
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <th>
                             <button onclick="estadoLoja(<?= $l['id_login_academia']; ?>,1)" type="button" class="btn btn-outline-dark">Desativar</button>
                             <a href="Lojas-Editar.php?idLoja=<?= $l['id_login_academia']; ?>">
                             <button onclick="EditarLoja(<?= $l['id_login_academia']; ?>)" type="button" class="btn btn-outline-primary">
                                    Editar
                             </button>
                        </a>
                        </th>
                       <?php }else if($l['status'] == 'desativado'){ ?>
                        ...
                        <th>
                             <button onclick="estadoLoja(<?= $l['id_login_academia']; ?>,2)" type="button" class="btn btn-outline-warning">
                                    Reativar
                             </button>
                        </th>
                        </tr>
