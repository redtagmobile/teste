                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nome_loja" class="form-control" id="exampleInputUsername1" placeholder="Ex: Facebook">
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Nome do Responsavel</label>
                                                <input type="text" name="nome_responsavel" class="form-control" id="exampleInputUsername1" placeholder="nome">
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Email para acesso</label>
                                                <input type="text" name="email" class="form-control" id="exampleInputUsername1" placeholder="email">
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Senha</label>
                                                <input type="password" name="senha" class="form-control" id="exampleInputUsername1" placeholder="Ex: Academia etc...">
                                            </div>
                                            
                                      <input type="hidden" name="master" value="<?php echo $_SESSION['user'][0]['id_login_academia']; ?>">
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-8">
            <button type="Submit" class="btn btn-info btn-block" name="CadastrarLoja">Cadastrar</button>
		</div>
		<div class="col-md-2">
		</div>
	</div>
...
// var_dump($lojas ->read($_SESSION['user'][0]['fk_login_loja']));
