    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                <input type="hidden" onchange="mostraFicha(this)" id="id_da_porra_do_cliente" name="id_usuario" value="" />
...
<input type="hidden" value="<?= $_SESSION['user'][0]['id_login_academia'] ?>" id="id_loja">
