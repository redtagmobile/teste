...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Academia Adicionar Clientes</title>
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-10">
                                ...
                                <div class="card">
                                    <div class="card-header"><h3>Formulario de Cadastro de Clientes</h3></div>
                                    <div class="card-body">
                                       
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Nome do Cliente</label>
                                                <input id="cadastro_nome" type="text" class="form-control" id="exampleInputUsername1" placeholder="Ex: Lucas...">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Data de nascimento</label>
                                                <input id="cadastro_nascimento" class="form-control" type="date">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Idade</label>
                                                <input id="cadastro_idade" type="text" class="form-control" id="exampleInputUsername1" placeholder="Ex: 18">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Inicio</label>
                                                <input id="cadastro_inicio" class="form-control" type="date">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Reavaliação</label>
                                                <input id="cadastro_reavaliacao" class="form-control" type="date">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Objetivos</label>
                                            <textarea id="cadastro_objetivos" class="form-control" id="exampleTextarea1" rows="4" style="margin-top: 0px; margin-bottom: 0px; height: 170px;"></textarea>
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Email</label>
                                                <input id="cadastro_email" type="email" class="form-control" id="exampleInputUsername1" placeholder="Email">
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Senha</label>
                                                <input id="cadastro_senha" type="password" class="form-control" id="exampleInputUsername1" placeholder="***">
                                            </div>


                                        <input type="hidden" id="fk_login_loja" value="<?=$_SESSION['user'][0]['id_login_academia']?>">
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-8">
            <button type="button" class="btn btn-info btn-block" onclick="CreateClient()">Cadastrar</button>
		</div>
		<div class="col-md-2">
		</div>
	</div>
