...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Academia Adicionar </title>
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-10">
                                ...
                                <div class="card">
                                    <div class="card-header"><h3>Formulario de Cadastro de Personal Trainer</h3></div>
                                    <div class="card-body">
                                       
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Nome do Personal</label>
                                                <input id="cadastro_nome" type="text" class="form-control" id="exampleInputUsername1" placeholder="Ex: Lucas...">
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="exampleInputUsername1">Email</label>
                                                <input id="cadastro_email" type="text" class="form-control" id="exampleInputUsername1" placeholder="email...">
                                            </div>
                                            <div class="form-group">
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-8">
            <button type="button" class="btn btn-info btn-block" onclick="CreatePersonal()">Cadastrar</button>
		</div>
		<div class="col-md-2">
		</div>
	</div>
