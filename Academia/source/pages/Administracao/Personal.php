                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="top-menu d-flex align-items-center">
                            ...
                            <!-- <a href="#" class="badge badge-info mb-1">Master Admin - <?php //$_SESSION['user'][0]['nome']?></a> -->
...
<div class="col-md-3">
                        <a href="Personal-Adicionar.php"><button type="button" class="btn btn-outline-success">Adicionar Personal</button></a>
</div> 
<br>
...
<div class="container-fluid"> <!--div da tabela-->
        <div class="row">
            <div class="col-md-12">
                ...
                <tbody id="carregar_tabela_personal">
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="demoModalLabel">Editar Personal</h5>
         ...
         <div class="modal-body">
            <form role="form">
               ...
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" autocomplete="off" id="editar_email" />
               </div>
               <div class="form-group">
                  <label for="exampleInputPassword1">
                  Chave de treino
                  </label>
                  <input type="password" class="form-control" id="editar_chave" placeholder="digite a nova chave de treino" />
               </div>
               <br>
               <button onclick="UpdatePersonal()" type="button" class="btn btn-primary">
               Editar
               </button>
            </form>
         </div>
